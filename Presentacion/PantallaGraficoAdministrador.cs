...
{
    public partial class PantallaGraficoAdministrador : Form
    {
        public PantallaGraficoAdministrador()
        {
            InitializeComponent();
        }

        private void PantallaGraficoAdministrador_Load(object sender, EventArgs e)
        {
            GestorEstablecimientos gestor = new GestorEstablecimientos(new Data());
           
            DtMostrarDatos.DataSource = gestor.graficaAdmin(label5.Text);
